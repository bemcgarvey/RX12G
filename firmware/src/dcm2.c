...
void initDCM_IMU_uC(float *State) {
    ...
    q_dcm2 = DEFAULT_q_dcm2;
    q_gyro_bias2 = DEFAULT_q_gyro_bias2;
    r_acc2 = DEFAULT_r_acc2;
    r_a2 = DEFAULT_r_a2;
    float InitialDCMVariance = DEFAULT_q_dcm2_init;
    float InitialBiasVariance = DEFAULT_q_gyro_bias2_init;
...
void updateIMU(float *Gyroscope, float *Accelerometer, float h) {
